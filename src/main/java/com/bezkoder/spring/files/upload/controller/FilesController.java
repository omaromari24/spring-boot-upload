...
public class FilesController {
  ...
  @GetMapping("/docker")
  public ResponseEntity<ResponseMessage> testDocker()
  {
     try
     {
        storageService.testDocker();
     ...
     {
        e.printStackTrace();
        return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage(e.getMessage()));
     }
  }
}
